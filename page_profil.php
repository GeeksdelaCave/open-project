    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 text-center col-md-offset-2 pv-20">
                <h1 class="title object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">Profil utilisateur</h1>
            ...
            <div class="main col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-lg-offset-1">
                        <h3 class="title">Mes informations de contact</h3>
                        <ul class="list-icons">
